      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<c:url value='/portal/index'/>" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Leenclair</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="<c:url value='/portal/index'/>" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Freeboard</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<c:url value='/portal/board/list'/>" class="menu-link">
                    <div data-i18n="Without menu">목록</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<c:url value='/portal/board/write'/>" class="menu-link">
                    <div data-i18n="Without navbar">등록하기</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<c:url value='/'/>" class="menu-link">
                    <div data-i18n="Container">내가쓴글</div>
                  </a>
                </li>
              </ul>
            </li>
                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">어서오세요, ${sessionScope.username}님 🎉</h5>
                          <p class="mb-4">
                            이곳은 개발자 Leenclair의 개인 프로젝트 공간입니다.<br /> 다양한 활동을 기록중입니다.
                          </p>
                        ...
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="<c:url value='/assets/img/icons/unicons/chart-success.png'/>"
                                alt="chart success"
                                class="rounded"
                              />
                            </div>
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="<c:url value='/assets/img/icons/unicons/wallet-info.png'/>"
                                alt="Credit Card"
                                class="rounded"
                              />
                            </div>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="<c:url value='/assets/img/icons/unicons/paypal.png'/>" alt="Credit Card" class="rounded" />
                            </div>
                            <div class="dropdown">
                              <button
                                class="btn p-0"
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="<c:url value='/assets/img/icons/unicons/cc-primary.png'/>" alt="Credit Card" class="rounded" />
                            </div>
                            <div class="dropdown">
                              <button
                                class="btn p-0"
                      ...
                      <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                          <div class="d-flex p-4 pt-3">
                            <div class="avatar flex-shrink-0 me-3">
                              <img src="<c:url value='/assets/img/icons/unicons/wallet.png'/>" alt="User" />
                            </div>
                            <div>
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="<c:url value='/assets/img/icons/unicons/paypal.png'/>" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="<c:url value='/assets/img/icons/unicons/wallet.png'/>" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="<c:url value='/assets/img/icons/unicons/chart.png'/>" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="<c:url value='/assets/img/icons/unicons/cc-success.png'/>" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="<c:url value='/assets/img/icons/unicons/cc-warning.png'/>" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
